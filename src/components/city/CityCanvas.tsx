...
export default function CityCanvas({ selectedId, mode, shouldFocus, fastTravelRequest, onSelect, onInspect, onDismissDossier, dossierVisible, isMobile, mobileControlsHidden = false }: CityCanvasProps) {
