  ...
  return (
    ...
    >
      ...
      <ol className="tutorial-steps">
        <li>
          <span>01</span>
          <div><strong>Movimente-se</strong><p className="desktop-instruction">Clique no mapa e use WASD ou as setas.</p><p className="mobile-instruction">Toque nos prédios ou use a viagem rápida.</p></div>
        </li>
        <li>
          <span>02</span>
